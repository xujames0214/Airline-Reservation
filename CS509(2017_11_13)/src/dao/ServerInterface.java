...
public enum ServerInterface {
	...
	public Flights getDepartingFlights (String teamName, String airportCode, String date) {
	...
	public Flights getArrivingFlights (String teamName, String airportCode, String arrivingDate) {
